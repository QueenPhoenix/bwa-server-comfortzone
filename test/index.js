...
describe('API ENDPOINT TESTING', () => {
    ...
    it('GET Detail Page', (done) => {
        chai.request(app).get('/api/v1/member/detail-page/5e96cbe292b97300fc902224').end((err, res) => {
            expect(err).to.be.null
            expect(res).to.have.status(200)
            expect(res.body).to.be.an('object')
    ...
    it('POST Booking Page', (done) => {
        ...
        const dataSample = {
            ...
            firstName: 'Heliana', 
            lastName: 'Ch',
            email: 'heliaan@gmail.com',
            phoneNumber: '0986644467',
            accountHolder: 'Heliana',
            bankFrom: 'BNI',
        }
        ...
        .end((err, res) => {
            ...
            expect(res.body.booking).to.have.all.keys('payments', '_id', 'invoice',
            'bookingStartDate', 'bookingEndDate', 'total', 'itemId', 'memberId', '__v')
